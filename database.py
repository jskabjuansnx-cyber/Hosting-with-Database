...
DEFAULT_FLAGS = [
    ...
    "bot_enabled",
    "bot_locked",
    "forced_subscription",   # اشتراك إجباري في القناة
]
...
DEFAULT_CONFIG = {
    ...
    "sub_channel_id":       "",          # مثال: -1001234567890
    "sub_channel_username": "",          # مثال: mychannel (بدون @)
    "sub_channel_title":    "قناتنا",    # اسم القناة يظهر للمستخدم
}
...
DEFAULT_EMOJIS = {
    ...
    # ─── الاشتراك الإجباري ─────────────────────────────────
    "SUB_REQUIRED": ("🔔", "5798700621242568649", "رسالة الاشتراك الإجباري"),
    "SUB_CHANNEL":  ("📢", "4981474026779051847", "أيقونة القناة في رسالة الاشتراك"),
    "SUB_CHECK":    ("🔍", "5798700621242568649", "زر التحقق من الاشتراك"),
    "SUB_JOIN":     ("➕", "5215613971352004352", "زر الانضمام للقناة"),
    "SUB_SUCCESS":  ("✅", "5967518416800585747", "رسالة نجاح الاشتراك"),
    "SUB_FAIL":     ("❌", "5465665476971471368", "رسالة فشل التحقق"),
    # ─── مزايا جديدة ───────────────────────────────────────
